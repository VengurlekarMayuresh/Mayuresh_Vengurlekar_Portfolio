...
export default function Main() {
  ...
  return (
    <div className="flex lg:flex-row h-[95vh] md:h-[100vh] flex-col lg:items-start items-center justify-center gap-5 lg:gap-20 p-5 lg:pt-30 overflow-x-hidden relative">
